...
std::ostream& operator<<(std::ostream& out, Rgb value) {
  return out << "rgb("sv << static_cast<int>(value.red) << ","sv
             << static_cast<int>(value.green) << ","sv
             << static_cast<int>(value.blue) << ")"sv;
}
std::ostream& operator<<(std::ostream& out, Rgba value) {
  return out << "rgba("sv << static_cast<int>(value.red) << ","sv
             << static_cast<int>(value.green) << ","sv
             << static_cast<int>(value.blue) << ","sv << value.opacity << ")"sv;
}
...
struct PrintColor {
  ...
  void operator()(const std::string& col) const { out << col; }
  void operator()(svg::Rgb col) const { out << col; }
  void operator()(svg::Rgba col) const { out << col; }
};

std::ostream& operator<<(std::ostream& out, svg::Color color) {
  std::visit(svg::PrintColor(out), color);
  return out;
}
